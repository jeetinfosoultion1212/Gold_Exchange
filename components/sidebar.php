...
<aside class="w-16 bg-slate-900 flex flex-col items-center py-4 space-y-4 fixed left-0 top-0 h-full z-40 overflow-y-auto">
    ...
    <!-- Gold Exchange Icon (F12) -->
    <a href="gold_exchange.php" 
       class="w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-200 <?= $current_page === 'gold_exchange.php' ? 'bg-orange-500/20 text-orange-300' : 'text-orange-200 hover:text-orange-300 hover:bg-orange-500/10' ?>"
    ...
    <a href="sell_gold.php" 
       class="w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-200 <?= $current_page === 'sell_gold.php' ? 'bg-green-500/20 text-green-300' : 'text-green-200 hover:text-green-300 hover:bg-green-500/10' ?>"
       title="Sell Gold (F2)">
        <i class="fas fa-shopping-cart text-xl"></i>
    </a>

    <!-- Purchase Gold Icon (F3) -->
    <a href="purchase.php" 
    ...
    <!-- Gold Receipt Icon (F8) -->
    <a href="gold_receipt.php" 
       class="w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-200 <?= $current_page === 'gold_receipt.php' ? 'bg-yellow-500/20 text-yellow-300' : 'text-yellow-200 hover:text-yellow-300 hover:bg-yellow-500/10' ?>"
