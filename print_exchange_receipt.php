...
function renderThermalReceipt($pdf, $company_name, $transaction, $date, $time) {
    ...
    $html .= '<table style="margin-bottom: 0.2mm;">
                ...
                <tr><td style="text-align:center; font-size:12px; font-weight:bold; padding:0; margin:0; line-height:1.1;">GOLD EXCHANGE RECEIPT</td></tr>
    ...
    $html .= '<table style="font-size:9px; margin:0.6mm 0;">
                <tr>
                    <td width="50%" style="padding:0.3mm 0; color:#666; font-weight:bold;">Received Weight:</td>
                    <td width="50%" style="text-align:right; padding:0.3mm 0; font-weight:bold;">' . number_format((float)$transaction['received_weight'], 3) . ' g</td>
                </tr>
                <tr>
                ...
                <tr style="background-color:#e8e8e8;">
                    <td style="padding:0.3mm 0; color:#666; font-weight:bold;">Fine Weight:</td>
                    <td style="text-align:right; padding:0.3mm 0; font-weight:bold;">' . number_format((float)$transaction['fine_weight'], 3) . ' g</td>
                </tr>
                <tr>
                    <td style="padding:0.3mm 0; color:#666; font-weight:bold;">Issue Weight:</td>
                    <td style="text-align:right; padding:0.3mm 0; font-weight:bold;">' . number_format((float)$transaction['delivered_weight'], 3) . ' g</td>
                </tr>
                <tr style="background-color:#e8e8e8;">
                    <td style="padding:0.3mm 0; color:#666; font-weight:bold;">Difference:</td>
                    <td style="text-align:right; padding:0.3mm 0; font-weight:bold;">' . number_format((float)$transaction['difference_weight'], 3) . ' g</td>
                </tr>
                <tr>
    ...
    $html .= '<table style="font-size:10px; margin:0.6mm 0;">
                <tr>
                    <td width="50%" style="padding:0.4mm 0; font-weight:bold;">Amount:</td>
                    <td width="50%" style="text-align:right; padding:0.4mm 0; font-weight:bold; font-size:12px;">Rs.' . number_format((float)$transaction['amount'], 2) . '</td>
                </tr>
                <tr>
