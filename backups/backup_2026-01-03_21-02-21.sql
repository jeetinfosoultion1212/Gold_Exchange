...
-- Table: book_gold_transactions
CREATE TABLE `book_gold_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `party_id` int(11) NOT NULL,
  `transaction_type` enum('Booking','Sale','Purchase','Refine') NOT NULL,
  `date_of_transaction` datetime NOT NULL,
  `booking_weight` decimal(10,3) DEFAULT 0.000,
  `received_weight` decimal(10,3) DEFAULT 0.000,
  `delivered_weight` decimal(10,3) DEFAULT 0.000,
  `fine_weight` decimal(10,3) DEFAULT 0.000,
  ...
  `amount_type` enum('cash_in','cash_out') DEFAULT 'cash_in',
  `narration` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `fk_book_gold_company` (`company_id`),
  KEY `fk_book_gold_party` (`party_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `gold_stock` (`id`, `company_id`, `purity`, `stock_name`, `current_stock`, `last_updated`, `created_at`) VALUES ('1', '7', '99.50', '', '-663.000', '2025-11-24 06:37:59', '2025-11-24 06:33:26');
INSERT INTO `gold_stock` (`id`, `company_id`, `purity`, `stock_name`, `current_stock`, `last_updated`, `created_at`) VALUES ('2', '7', '99.90', '', '-137.000', '2025-11-24 06:36:59', '2025-11-24 06:36:59');
...
INSERT INTO `parties` (`id`, `company_id`, `party_name`, `contact_no`, `address`, `current_balance`, `current_gold_balance`, `cash_balance`, `bank_balance`, `cash_gold_balance`, `bank_gold_balance`, `created_at`, `updated_at`) VALUES ('1', '9', 'ABC', '', '', '0.00', '0.000', '0.00', '0.00', '0.000', '0.000', '2025-11-24 06:11:02', '2025-11-24 06:11:02');
INSERT INTO `parties` (`id`, `company_id`, `party_name`, `contact_no`, `address`, `current_balance`, `current_gold_balance`, `cash_balance`, `bank_balance`, `cash_gold_balance`, `bank_gold_balance`, `created_at`, `updated_at`) VALUES ('2', '7', 'abc', '', '', '1252000.00', '-120.000', '0.00', '1252000.00', '0.000', '0.000', '2025-11-24 06:32:45', '2025-11-24 06:33:26');
INSERT INTO `parties` (`id`, `company_id`, `party_name`, `contact_no`, `address`, `current_balance`, `current_gold_balance`, `cash_balance`, `bank_balance`, `cash_gold_balance`, `bank_gold_balance`, `created_at`, `updated_at`) VALUES ('3', '7', 'advance', '', '', '3755880.00', '-680.000', '2093663.00', '1662217.00', '0.000', '0.000', '2025-11-24 06:34:18', '2025-11-24 06:37:59');
...
CREATE TABLE `transactions` (
  ...
  `party_id` int(11) NOT NULL,
  `receipt_id` varchar(50) NOT NULL,
  `transaction_type` enum('Booking','Sale','Purchase','Received','Payment','Gold_Received') NOT NULL,
  `date_of_transaction` datetime NOT NULL,
...
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('1', '9', NULL, '1', 'B91', 'Booking', '2025-11-24 11:40:00', '100.000', '99.50', '12446.00', '1244600.00', '0.00', 'Cash', 'Payment_In', 'Cash', '0.00', '0.00', '0.000', '0.000', 'Bank', '', '2025-11-24 06:11:20', '2025-11-24 06:11:20');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('2', '7', NULL, '2', 'B71', 'Booking', '2025-11-24 12:02:00', '143.000', '99.50', '14600.00', '2087800.00', '0.00', 'Cash', 'Payment_In', 'Cash', '0.00', '0.00', '0.000', '0.000', 'Bank', '', '2025-11-24 06:33:04', '2025-11-24 06:33:04');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('3', '7', NULL, '2', 'S7001', 'Sale', '2025-11-24 12:03:00', '120.000', '99.50', '14600.00', '1752000.00', '500000.00', '', 'Payment_Out', 'Cash', '0.00', '-1752000.00', '143.000', '23.000', 'Bank', 'Gold sale transaction - S7001', '2025-11-24 06:33:26', '2025-11-24 06:33:26');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('4', '7', NULL, '2', 'BNK-20251124-1709', 'Received', '2025-11-24 12:03:00', '0.000', '0.00', '0.00', '0.00', '500000.00', 'Bank', 'Payment_In', 'Cash', '0.00', '-500000.00', '23.000', '23.000', 'Bank', 'Bank received for sale S7001 via RTGS', '2025-11-24 06:33:26', '2025-11-24 06:33:26');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('5', '7', NULL, '3', 'S7002', 'Sale', '2025-11-24 12:04:00', '400.000', '99.50', '13641.00', '5456400.00', '5000000.00', '', 'Payment_Out', 'Cash', '0.00', '0.00', '400.000', '0.000', 'Bank', 'Gold sale transaction - S7002', '2025-11-24 06:34:40', '2025-11-24 06:34:55');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('6', '7', NULL, '3', 'BNK-20251124-2410', 'Received', '2025-11-24 12:04:00', '0.000', '0.00', '0.00', '0.00', '5000000.00', 'Bank', 'Payment_In', 'Cash', '0.00', '-5000000.00', '0.000', '0.000', 'Bank', 'Bank received for sale S7002 via RTGS', '2025-11-24 06:34:40', '2025-11-24 06:34:40');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('7', '7', NULL, '3', 'PAY7001', 'Received', '2025-11-24 12:05:00', '0.000', '0.00', '0.00', '0.00', '300000.00', 'Bank', 'Payment_In', 'Cash', '5000000.00', '5300000.00', '0.000', '0.000', 'Bank', 'Payment received - PAY7001', '2025-11-24 06:35:21', '2025-11-24 06:35:21');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('8', '7', NULL, '3', 'B72', 'Booking', '2025-11-24 12:05:00', '143.000', '99.50', '14641.00', '2093663.00', '0.00', 'Cash', 'Payment_In', 'Cash', '0.00', '0.00', '0.000', '0.000', 'Bank', '', '2025-11-24 06:36:11', '2025-11-24 06:36:11');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('9', '7', NULL, '3', 'S7003', 'Sale', '2025-11-24 12:06:00', '137.000', '99.90', '14641.00', '2005817.00', '500000.00', '', 'Payment_Out', 'Cash', '0.00', '-2005817.00', '-257.000', '-394.000', 'Bank', 'Gold sale transaction - S7003', '2025-11-24 06:36:59', '2025-11-24 06:36:59');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('10', '7', NULL, '3', 'BNK-20251124-8511', 'Received', '2025-11-24 12:06:00', '0.000', '0.00', '0.00', '0.00', '500000.00', 'Bank', 'Payment_In', 'Cash', '0.00', '-500000.00', '-394.000', '-394.000', 'Bank', 'Bank received for sale S7003 via RTGS', '2025-11-24 06:36:59', '2025-11-24 06:36:59');
INSERT INTO `transactions` (`id`, `company_id`, `user_id`, `party_id`, `receipt_id`, `transaction_type`, `date_of_transaction`, `gold_weight`, `purity`, `rate`, `gold_amount`, `payment_amount`, `payment_method`, `payment_type`, `receipt_method`, `party_balance_before`, `party_balance_after`, `party_gold_balance_before`, `party_gold_balance_after`, `booking_type`, `narration`, `created_at`, `updated_at`) VALUES ('11', '7', NULL, '3', 'S7004', 'Sale', '2025-11-24 12:07:00', '143.000', '99.50', '14641.00', '2093663.00', '0.00', '', 'Payment_Out', 'Cash', '0.00', '-2093663.00', '143.000', '0.000', 'Cash', 'Gold sale transaction - S7004', '2025-11-24 06:37:59', '2025-11-24 06:37:59');
...
INSERT INTO `users` (`id`, `company_id`, `username`, `email`, `password`, `full_name`, `role`, `remember_token`, `remember_expires`, `last_login`, `created_at`, `status`) VALUES ('9', '9', 'prosen21', 'xyx@gmail.com', '$2y$10$x03XfBfzvb1VXTRe7Lk60.1RIYcxZpBAtL5TNw9QdtQ9Tk1zKo9Mu', 'demo', 'Admin', NULL, NULL, '2026-01-03 21:02:13', '2025-11-23 09:48:39', 'Active');
